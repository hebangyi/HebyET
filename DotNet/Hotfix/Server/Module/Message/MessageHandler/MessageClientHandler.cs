...
namespace ET.Server
{
    ...
    public abstract class MessageCleintHandler<E, Message>: HandlerObject, IMHandler where E : Entity where Message : class, IClientMessage
    {
    ...
    public abstract class MessageClientHandler<E, Request, Response>: HandlerObject, IMHandler where E : Entity where Request : MessageObject, IClientRequest where Response : MessageObject, IClientResponse
    {
